    ...
    <div class="flex">
        <aside class="w-64 min-h-screen bg-slate-900/50 border-r border-amber-900/30 p-4">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('admin.betting.deposit-methods.index') }}" class="block px-4 py-2 rounded-lg hover:bg-amber-500/20 {{ request()->routeIs('admin.betting.deposit-methods.*') ? 'bg-amber-500/20 text-amber-400' : 'text-gray-400' }}">Deposit wallets</a>
                <a href="{{ route('admin.betting.funding.index') }}" class="block px-4 py-2 rounded-lg hover:bg-amber-500/20 {{ request()->routeIs('admin.betting.funding.*') ? 'bg-amber-500/20 text-amber-400' : 'text-gray-400' }}">Deposits / withdraw</a>
